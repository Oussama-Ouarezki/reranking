...
Walks sibling model folders (runs/<model>/<timestamp>.json), extracts only
aggregate metrics and duration, and writes runs/metrics_summary.json.

Usage (from any directory):
  python application/cache/runs/export_metrics.py
"""
...
OUT      = RUNS_DIR / "metrics_summary.json"
