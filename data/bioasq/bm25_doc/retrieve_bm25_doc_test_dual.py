"""
BM25 retrieval over BioASQ Task13BGoldenEnriched test set — dual-bar chart.
...
Writes to   : data/bioasq/bm25_doc/images/recall_precision_at_k_test.png

Usage:
    python data/bioasq/bm25_doc/retrieve_bm25_doc_test_dual.py
    python data/bioasq/bm25_doc/retrieve_bm25_doc_test_dual.py --k1 0.7 --b 0.9
"""
...
def plot_dual(mean_recall, mean_precision, out_path, k1, b):
    ...
    ax.set_title(
        ...
        f'(k1={k1}, b={b})  [BioASQ test set: 13B1–13B4]',
        fontsize=13, pad=12
    )
...
def main():
    ...
    plot_dual(mean_recall, mean_precision,
              OUT_DIR / 'recall_precision_at_k_test.png', args.k1, args.b)
    print('\nDone.')
