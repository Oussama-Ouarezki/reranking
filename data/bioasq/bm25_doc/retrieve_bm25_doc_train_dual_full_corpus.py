...
Full corpus variant: uses corpus_full_processed.jsonl (257 907 docs).
...
Reads from  : data/bioasq/pubmed_full/full/corpus_full_processed.jsonl
              data/bioasq/processed/queries.jsonl
              data/bioasq/processed/qrels.tsv
Writes to   : data/bioasq/bm25_doc/images/recall_precision_at_k_train_full_corpus.png

Usage:
    python data/bioasq/bm25_doc/retrieve_bm25_doc_train_dual_full_corpus.py
    python data/bioasq/bm25_doc/retrieve_bm25_doc_train_dual_full_corpus.py --k1 0.7 --b 0.9
"""
...
def plot_dual(
    ...
    ax.set_title(
        ...
        f'(k1={k1}, b={b})  [BioASQ training set — full corpus, 257 907 docs]',
        fontsize=13, pad=12,
    )
...
def main() -> None:
    ...
    corpus_ids, corpus_texts = load_corpus(CORPUS)
    ...
    plot_dual(mean_recall, mean_precision,
              OUT_DIR / 'recall_precision_at_k_train_full_corpus.png',
              args.k1, args.b)
    print('\nDone.')
