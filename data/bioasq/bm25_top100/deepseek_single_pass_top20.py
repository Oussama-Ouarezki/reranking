"""
Single-pass listwise reranking with DeepSeek-Chat on BioASQ top-20 BM25 docs.
All 20 docs are ranked in one shot — no sliding window.

Config: top_n=20, max_tokens=512, single pass.
...
Usage:
    ...
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_single_pass_top20.py --n-queries 10
"""
...
OUT_FILE = BASE / "data/bioasq/bm25_top100/deepseek_single_pass_top20_reranked.jsonl"
...
def main() -> None:
    ...
    print(f"Config: top-{TOP_N} docs | single pass | max_tokens={MAX_TOKENS} | model={args.model}")
