"""
Sliding-window listwise reranking — top-30, window=10, step=10.

3 non-overlapping passes (bottom-up):
  Pass 1: positions [20:30]
  Pass 2: positions [10:20]
  Pass 3: positions [ 0:10]
...
Writes:
  data/bioasq/bm25_top100/deepseek_sliding_top30_w10.jsonl
...
Usage:
    ...
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_sliding_top30_w10.py --n-queries 1
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_sliding_top30_w10.py
"""
...
OUT_FILE = BASE / "data/bioasq/bm25_top100/deepseek_sliding_top30_w10.jsonl"
...
def build_user_prompt(query: str, docs: list, bm25_scores: list) -> str:
    ...
    lines.append(
        f"\nReturn a JSON object with key \"ranking\" containing "
...
def main() -> None:
    ...
    print(f"Config: top-{TOP_N} | window={WINDOW_SIZE} | step={STEP} | "
          f"{MAX_TOKENS} tok/doc | model={args.model}")
