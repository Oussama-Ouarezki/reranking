...
Config: top_n=20, window=10, step=3, max_tokens=512.

Algorithm (RankGPT-style, bottom-up):
  For N=20 docs, window=10, step=3:
    Pass 1: rerank positions [10-20]
    Pass 2: rerank positions [7-17]
    Pass 3: rerank positions [4-14]
    Pass 4: rerank positions [1-11]
...
Writes:
  data/bioasq/bm25_top100/deepseek_sliding_reranked_prompt_2_top20_w10_s3.jsonl

Usage:
    export DEEPSEEK_API_KEY="sk-..."
    cd /home/oussama/Desktop/reranking_project
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_sliding_window_prompt_2_top20_w10_s3.py --n-queries 10
"""
...
OUT_FILE = BASE / "data/bioasq/bm25_top100/deepseek_sliding_reranked_prompt_2_top20_w10_s3.jsonl"
