...
Config: top_n=30, window=20, step=10, max_tokens=512.

Algorithm (RankGPT-style, bottom-up):
  For N=30 docs, window=20, step=10:
    Pass 1: rerank positions [10-30]
    Pass 2: rerank positions [0-20]   (final top-20 locked in)
...
Usage:
    ...
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_sliding_window_prompt_2_top30_w20_s10.py --n-queries 1
"""
...
OUT_FILE = BASE / "data/bioasq/bm25_top100/deepseek_sliding_reranked_prompt_2_top30_w20_s10.jsonl"
