"""
Sliding-window listwise reranking with DeepSeek-Chat on BioASQ top-30 BM25 docs.

Algorithm (RankGPT-style, bottom-up):
  For N=30 docs, window=10, step=5:
    Pass 1: rerank positions [20-30]
    Pass 2: rerank positions [15-25]
    Pass 3: rerank positions [10-20]
    Pass 4: rerank positions [ 5-15]
    Pass 5: rerank positions [ 0-10]
...
Writes:
  data/bioasq/bm25_top100/deepseek_sliding_reranked_top30_w10_s5.jsonl
...
Usage:
    ...
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_sliding_window_top30.py --n-queries 1
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/deepseek_sliding_window_top30.py
"""
...
OUT_FILE = BASE / "data/bioasq/bm25_top100/deepseek_sliding_reranked_top30_w10_s5.jsonl"
