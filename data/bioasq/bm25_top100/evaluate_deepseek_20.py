...
Reads:
  ...
  data/bioasq/bm25_top100/deepseek_chat_reranked_20.jsonl

Writes:
  data/bioasq/bm25_top100/images/evaluation_bm25_vs_deepseek_chat20.png
...
DS20_FILE  = BASE / "data/bioasq/bm25_top100/deepseek_chat_reranked_20.jsonl"
...
def plot(bm25: dict[str, float], ds: dict[str, float], n_queries: int) -> None:
    ...
    fig.suptitle(
        f"BM25 vs DeepSeek-Chat Reranking — BioASQ  ({n_queries} queries, top-20)",
        fontsize=13, y=1.01,
    )
    ...
    out = IMG_DIR / "evaluation_bm25_vs_deepseek_chat20.png"
    fig.tight_layout()
...
def main() -> None:
    ...
    print(f"Loading DeepSeek-Chat reranked results from {DS20_FILE.name} …")
    ds_results = load_reranked(DS20_FILE)
