...
Writes:
  data/bioasq/bm25_top100/images/evaluation_bm25_vs_deepseek50.png
...
DS50_FILE   = BASE / "data/bioasq/bm25_top100/deepseek_reranked_50.jsonl"
...
def plot(bm25: dict[str, float], ds: dict[str, float], n_queries: int) -> None:
    ...
    fig.suptitle(
        f"BM25 vs DeepSeek-Reasoner Reranking — BioASQ  ({n_queries} queries, top-50)",
        fontsize=13, y=1.01,
    )
    ...
    out = IMG_DIR / "evaluation_bm25_vs_deepseek50.png"
    fig.tight_layout()
...
def main() -> None:
    ...
    print(f"Loading DeepSeek reranked results from {DS50_FILE.name} …")
    ds_results = load_reranked(DS50_FILE)
