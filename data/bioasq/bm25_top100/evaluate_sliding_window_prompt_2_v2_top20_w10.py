"""
Evaluate BM25 (top-50) vs DeepSeek reranked (top-50, v2_300) on BioASQ.
Variant: prompt_2 with 300 tokens per passage.

Metrics: nDCG@1, nDCG@5, nDCG@10, nDCG@20, nDCG@50,
...
Reads:
  ...
  data/bioasq/bm25_top100/deepseek_sliding_reranked_prompt_2_v2_300.jsonl

Writes:
  data/bioasq/bm25_top100/images/evaluation_bm25_vs_sliding_window_prompt_2_v2_300.png

Usage:
    cd /home/oussama/Desktop/reranking_project
    /home/oussama/miniconda3/envs/pyml/bin/python \\
        data/bioasq/bm25_top100/evaluate_sliding_window_prompt_2_v2_300.py
"""
...
DS_SW_FILE  = BASE / "data/bioasq/bm25_top100/deepseek_sliding_reranked_prompt_v2_top20_w10_s5.jsonl"
...
def _draw_panel(ax: plt.Axes, metrics: list[str], bm25: dict[str, float],
    ...
    bars_d = ax.bar(x + w / 2, ds_vals,   w,
                    label="DeepSeek-Chat Sliding Prompt v2 (300 tok/doc, w=20/s=10)",
...
def plot(bm25: dict[str, float], ds: dict[str, float], n_queries: int) -> None:
    ...
    fig.suptitle(
        f"BM25 vs DeepSeek-Chat Sliding Window (Prompt v2, 300 tok/doc) — BioASQ "
        f"({n_queries} queries, top-50, w=20/s=10)",
        fontsize=13, y=1.01,
    )
    ...
    out = IMG_DIR / "evaluation_bm25_vs_sliding_window_prompt_2_v2_300.png"
    fig.tight_layout()
