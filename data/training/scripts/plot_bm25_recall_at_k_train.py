"""
Plot BM25 Recall@K curve on the truncated BioASQ training set.
Saves: data/training/images/bm25_recall_at_k_train.png
"""
...
# ── Config ────────────────────────────────────────────────────────────────────
DATA_DIR     = Path("data/training/truncated")
CORPUS_FILE  = DATA_DIR / "corpus.jsonl"
QUERIES_FILE = DATA_DIR / "queries.jsonl"
QRELS_FILE   = DATA_DIR / "qrels.tsv"
OUT_PNG      = Path("data/training/images/bm25_recall_at_k_train.png")
...
bars     = ax.bar(x, recalls, color="#2196F3", alpha=0.85, width=0.6, label="Training set")
...
ax.set_title("BM25 Recall@K — BioASQ Truncated Training Set", fontsize=13)
ax.set_ylim(0, 1.05)
