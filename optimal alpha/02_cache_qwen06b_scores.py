"""Cache Qwen3-Reranker-0.6B scores for the 500-query training sample.

Identical scoring to qwen3_0.6b/02_cache_qwen06b_scores.py.

Reads:  optimal alpha/data/bm25_top50_train500.jsonl
Writes: optimal alpha/data/qwen06b_scores_train500.jsonl
"""
...
IN  = BASE / "optimal alpha/data/bm25_top50_train500.jsonl"
OUT = BASE / "optimal alpha/data/qwen06b_scores_train500.jsonl"
