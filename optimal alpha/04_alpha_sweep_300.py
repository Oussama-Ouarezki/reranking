"""Find optimal LF α on a 300-query subset of the training sample.

Uses the first 300 of the already-scored 500 train queries (SEED=42 sample).
Sweeps α ∈ {0.9, 0.99, ..., 0.9999999999} (10 nines) plus pure Qwen.

Reads:  optimal alpha/data/qwen06b_scores_train500.jsonl
        optimal alpha/data/qrels_train500.tsv
Writes: optimal alpha/results/alpha_sweep_300.tsv
        optimal alpha/results/alpha_best_300.json
        optimal alpha/plots/alpha_bar_clusters_300.png
"""
...
OUT_TSV  = BASE / "optimal alpha/results/alpha_sweep_300.tsv"
OUT_JSON = BASE / "optimal alpha/results/alpha_best_300.json"
OUT_PLOT = BASE / "optimal alpha/plots/alpha_bar_clusters_300.png"
