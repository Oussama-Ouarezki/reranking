"""Cache Qwen3-Reranker-0.6B pointwise relevance probabilities for BM25 top-50.

Mirrors application/backend/rerankers/qwen3.py (FP16, last-token yes/no logit
softmax). Resumable: skips qids already present in the output.

Reads:  qwen3_0.6b/data/bm25_top50_test.jsonl
Writes: qwen3_0.6b/data/qwen06b_scores_test.jsonl
...
IN = BASE / "qwen3_0.6b/data/bm25_top50_test.jsonl"
OUT = BASE / "qwen3_0.6b/data/qwen06b_scores_test.jsonl"
