"""Cache Qwen3-Reranker-4B pointwise relevance probabilities for top-50 BM25 hits.

Standalone scorer mirroring application/backend/rerankers/qwen3.py (FP16, last-token
yes/no logit softmax).

Reads:  qwen4b_uncertainty/data/bm25_top50.jsonl
Writes: qwen4b_uncertainty/data/qwen_scores.jsonl
        one record per query:
        {qid, type, scores: [{docid, qwen_prob, bm25_score}]}
...
IN = BASE / "qwen4b_uncertainty/data/bm25_top50.jsonl"
OUT = BASE / "qwen4b_uncertainty/data/qwen_scores.jsonl"
