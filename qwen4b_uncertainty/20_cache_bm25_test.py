"""Cache BM25 top-50 (Pyserini, k1=0.7, b=0.9) for the Task13BGoldenEnriched test set.

Reads:
  data/bioasq/raw/Task13BGoldenEnriched/queries_full.jsonl  (340 queries)
  data/bm25_indexing_full/corpus_full/lucene_index
  data/bioasq/pubmed_full/full/corpus_full.jsonl

Writes:
  qwen4b_uncertainty/data/bm25_top50_test.jsonl
...
QUERIES = BASE / "data/bioasq/raw/Task13BGoldenEnriched/queries_full.jsonl"
...
OUT = BASE / "qwen4b_uncertainty/data/bm25_top50_test.jsonl"
