...
DATA = {
    ...
    "factoid_mrr": np.array([
        ...
        [0.3288, 0.3296, 0.3372, 0.2930, 0.0211],  # BM25 → Qwen3-0.6B + BM25 (LF α=0.999) → LiT5 top-20
    ]),
    ...
    "yesno_acc": np.array([
        ...
        [0.9146, 0.9146, 0.8902, 0.7561, 0.1585],  # BM25 → Qwen3-0.6B + BM25 (LF α=0.999) → LiT5 top-20
    ]),
    ...
    "summary_llm": np.array([
        ...
        [0.5844, 0.6364, 0.6234, 0.7013, 0.3896],  # BM25 → Qwen3-0.6B + BM25 (LF α=0.999) → LiT5 top-20
    ]),
}
